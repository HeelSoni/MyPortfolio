...
function ProjectCard({ project, index }: { project: typeof projects[0], index: number }) {
  ...
  return (
    ...
    >
      <a 
        href={project.link}
        className="flex flex-col h-full bg-white/[0.02] backdrop-blur-2xl border border-white/[0.08] rounded-[2.5rem] p-10 transition-all duration-700 hover:shadow-[0_0_50px_rgba(99,102,241,0.2)] hover:translate-y-[-15px] hover:border-indigo-500/50 overflow-hidden min-h-[460px]"
      >
        ...
        <div className="flex justify-between items-start mb-auto relative z-10">
          <div className="max-w-[80%]">
            <span className="text-indigo-400 text-[10px] font-mono tracking-[0.4em] uppercase mb-6 block opacity-50">
        ...
        <div className="relative z-10 mt-10">
          <p className="text-white/40 font-light mb-12 text-lg md:text-xl leading-relaxed line-clamp-3 group-hover:text-white/60 transition-colors duration-500">
            {project.description}
          </p>
  ...
  return (
    <section id="work" className="py-32 px-6 container mx-auto max-w-7xl relative overflow-hidden perspective-normal">
      ...
      <div className="mb-24 text-center md:text-left">
        ...
        >
          <h2 className="font-display text-[var(--font-h1)] font-bold tracking-tighter mb-6 leading-none text-white lg:text-indigo-400">
